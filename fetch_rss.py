...
def get_url():
    ...
    url = 'https://www.upwork.com/ab/feed/jobs/rss?' + prv +\
        ...
        '&hourly_rate=50-&job_type=hourly&proposals=0-4,5-9,10-14&q='+\
        'skills:("google analytics" OR airtable OR "google sheets" OR excel OR R OR sql OR dashboard OR "data analytics" OR "data analysis")'
